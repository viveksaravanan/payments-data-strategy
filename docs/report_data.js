...
window.REPORT_DATA = {
  "generated_at": "2026-05-10T15:19:11",
  "window": {
    "start": "2026-03-01",
    "end": "2026-05-29",
    "days": 90
  ...
  "stores": [
    {
      "store_id": "ACM-NC-0001",
      "merchant_id": "ACM",
      "latitude": 35.07173,
      "longitude": -80.91002,
      "neighborhood": "Pineville",
      "metro_region": "outer_suburbs",
      "store_zip5": "28134"
    },
    {
      "store_id": "ACM-NC-0002",
      "merchant_id": "ACM",
      "latitude": 35.31619,
      "longitude": -80.75499,
      "neighborhood": "University City",
      "metro_region": "inner_suburbs",
      "store_zip5": "28213"
    },
    {
      "store_id": "ACM-NC-0003",
      "merchant_id": "ACM",
      "latitude": 35.10369,
      "longitude": -80.7158,
    ...
    {
      "store_id": "ACM-NC-0004",
      "merchant_id": "ACM",
      "latitude": 35.24861,
      "longitude": -80.83125,
      "neighborhood": "NoDa",
      "metro_region": "urban_core",
      "store_zip5": "28206"
    },
    {
      "store_id": "ACM-NC-0005",
      "merchant_id": "ACM",
      "latitude": 35.38784,
      "longitude": -80.66819,
    ...
    {
      "store_id": "ACM-NC-0012",
      "merchant_id": "ACM",
      "latitude": 35.21135,
      "longitude": -80.85364,
      "neighborhood": "Uptown / Center City",
      "metro_region": "urban_core",
      "store_zip5": "28202"
    },
    {
      "store_id": "ACM-NC-0013",
      "merchant_id": "ACM",
      "latitude": 35.31257,
      "longitude": -80.77696,
      "neighborhood": "University City",
  ...
  "cohorts": {
    "n_at_all_3_grocers": 2947,
    "n_at_any_2_grocers": 8637,
    "n_at_grocer_and_qsr": 8333,
    "n_at_grocer_and_retail": 4643,
    "n_at_all_5": 1152
  },
  "catalog_stats": {
    "per_grocer": [
  ...
  "catalog_sample_products": [
    ...
    {
      "name": "80/20 ground beef (lb)",
      "category": "MEAT",
      "subcategory": "beef",
      "base_price": 5.95
    },
    {
      "name": "Sourdough sliced loaf (24 oz)",
      "category": "BAKERY",
      "subcategory": "bread",
      "base_price": 5.0
    },
    {
      "name": "Spaghetti (1 lb box)",
      "category": "PANTRY",
      "subcategory": "pasta",
      "base_price": 2.01
    },
    {
      "name": "Frozen cheese pizza (12-inch)",
      "category": "FROZEN",
      "subcategory": "pizza",
      "base_price": 5.04
    },
    {
      "name": "Paper towels (6 mega rolls)",
      "category": "HOUSEHOLD",
      "subcategory": "paper",
      "base_price": 13.71
    },
    {
      "name": "Diapers size 3 Huggies (62-count)",
      "category": "BABY",
      "subcategory": "diapers",
      "base_price": 24.41
    }
  ],
  "daily_volume_5merchant": [
    {
      "date": "2026-03-01",
      "KRG": 989,
      "ACM": 961,
  ...
  "anomaly_series": {
    "university_city_decline": {
      "by_stage": [
        {
          "stage": "Baseline (Mar 1 \u2013 Apr 11)",
          "window": "2026-03-01 \u2192 2026-04-11",
          "KRG": 23.05,
          "ACM": 25.76,
          "WDX": 27.42
        },
        {
          "stage": "Stage 1 (Apr 12 \u2013 Apr 18)",
          "window": "2026-04-12 \u2192 2026-04-18",
          "KRG": 24.93,
          "ACM": 27.38,
          "WDX": 29.76
        },
        {
          "stage": "Stage 2 (Apr 19 \u2013 Apr 25)",
          "window": "2026-04-19 \u2192 2026-04-25",
          "KRG": 18.93,
          "ACM": 24.52,
          "WDX": 24.62
        },
        {
          "stage": "Stage 3 (Apr 26 \u2013 May 2)",
        ...
        {
          "stage": "Stage 4 (May 3 \u2013 May 29)",
          "window": "2026-05-03 \u2192 2026-05-29",
          "KRG": 16.89,
          "ACM": 21.95,
          "WDX": 23.54
        }
  ...
  "lake_schema_annotations": {
    "lake_transactions": [
      {
        "name": "lake_txn_id",
        "source": "txn_id, line_id",
        "treatment": "transformed",
        "note": "salted SHA-256, 16 chars; replaces merchant-prefixed txn_id"
      },
      {
        "name": "line_id",
        "source": "line_id",
        "treatment": "carried",
        "note": "row position within the lake_txn_id"
      },
      {
        "name": "peer_id",
        "source": "merchant_id",
        "treatment": "transformed",
        "note": "pseudonymized as peer_a..peer_d per viewer-specific mapping"
      },
      {
        "name": "peer_segment",
        "source": "merchant.segment",
        "treatment": "carried",
        "note": "grocery / qsr / off_price_retail"
      },
      {
        "name": "lake_store_id",
        "source": "store_id",
        "treatment": "transformed",
        "note": "salted SHA-256, 16 chars"
      },
      {
        "name": "txn_date",
        "source": "txn_ts",
        "treatment": "transformed",
        "note": "full timestamp \u2192 date"
      },
      {
        "name": "txn_hour_bucket",
        "source": "txn_ts",
        "treatment": "transformed",
        "note": "full timestamp \u2192 10-bucket time-of-day label"
      },
      {
        "name": "payment_type",
        "source": "payment_type",
      ...
      },
      {
        ...
        "source": "card_network",
        "treatment": "carried",
        "note": "visa / mc / amex / discover"
      },
      {
        "name": "entry_mode",
        "source": "entry_mode",
        "treatment": "carried",
        "note": "contactless / chip / swipe / manual"
      },
      {
        "name": "wallet_type",
        "source": "wallet_type",
        "treatment": "carried",
        "note": "nullable: apple / google / samsung"
      },
      {
        "name": "connectivity_type",
        "source": "connectivity_type",
        "treatment": "carried",
        "note": "wifi / cellular_4g / cellular_5g / ethernet"
      },
      {
        "name": "txn_total_bin",
        "source": "txn_total",
        "treatment": "transformed",
        "note": "exact dollar amount \u2192 10-bin label ($0-5 ... $250+)"
      },
      {
        "name": "canonical_name",
        "source": "products.name",
        "treatment": "carried",
        "note": "product name; cross-merchant matching key"
      },
      {
        "name": "category",
      ...
      {
        "name": "subcategory",
        "source": "products.subcategory",
        "treatment": "carried",
        "note": ""
      },
      {
        "name": "unit_price",
        "source": "items.unit_price",
        "treatment": "carried",
        "note": "publicly observable, kept exact"
      },
      {
        "name": "qty",
        "source": "items.qty",
      ...
      {
        "name": "discount",
        "source": "items.discount",
        "treatment": "carried",
        "note": "publicly observable"
      },
      {
        "name": "line_total",
        "source": "items.line_total",
        "treatment": "carried",
        "note": "publicly observable"
      },
      {
        "name": "discount_pct_applied",
        "source": "discount / (unit_price \u00d7 qty)",
        "treatment": "derived",
        "note": "computed in the view; nullable when no discount"
      },
      {
        "name": "\u2014",
        "source": "customer_id",
        "treatment": "dropped",
        "note": "no consumer linkage in the lake"
      },
      {
        "name": "\u2014",
        "source": "merchant_id (real)",
        "treatment": "dropped",
        "note": "pseudonymized via peer_id"
      },
      {
        "name": "\u2014",
        "source": "terminal_id",
        "treatment": "dropped",
        "note": "device-level not surfaced (v2.5 scope)"
      },
      {
        "name": "\u2014",
        "source": "subtotal/tax_total/txn_total (line-level)",
        "treatment": "dropped",
        "note": "exact transaction-level rollups not exposed; txn_total_bin only"
      }
    ],
    "lake_stores": [
      {
        ...
        "source": "store_id",
        "treatment": "transformed",
        "note": "salted SHA-256; same value across viewers"
      },
      {
        "name": "peer_id",
        "source": "merchant_id",
        "treatment": "transformed",
        "note": "viewer-specific peer label"
      },
      {
        "name": "peer_segment",
        "source": "merchant.segment",
      ...
      },
      {
        ...
        "source": "store_zip5",
        "treatment": "dropped",
        "note": "full ZIP not surfaced"
      },
      {
        "name": "\u2014",
        "source": "latitude/longitude",
        "treatment": "dropped",
        "note": "exact coords not surfaced"
      },
      {
        "name": "\u2014",
        "source": "open_date",
